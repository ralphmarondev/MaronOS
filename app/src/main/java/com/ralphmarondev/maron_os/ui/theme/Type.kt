...
val Typography = Typography(
    ...
    labelLarge = baseline.labelLarge.copy(fontFamily = robotoMonoThin),
    labelMedium = baseline.labelMedium.copy(fontFamily = robotoMonoThin),
    labelSmall = baseline.labelSmall.copy(fontFamily = robotoMonoThin),
)
